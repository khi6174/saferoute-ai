      ...
      <div className="mx-auto max-w-7xl px-4 py-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black md:text-4xl">배송 안전 의사결정 대시보드</h1>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-200">{CORE_MESSAGE}</p>
            <p className="mt-1 max-w-3xl text-xs leading-5 text-slate-300">{RESPONSIBILITY_MESSAGE}</p>
          </div>
